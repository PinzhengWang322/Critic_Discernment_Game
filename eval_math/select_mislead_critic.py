...
"""
python select_mislead_critic.py \
--in_prover_path /online1/ycsc_lijt1/lijt1/wpz/Llama_CDG/dataset/prover_round2/outputs/concrete-critic/mislead.jsonl \
--in_critic_path /online1/ycsc_lijt1/lijt1/wpz/Llama_CDG/dataset/critic/outputs/mislead.jsonl \
--out_path /online1/ycsc_lijt1/lijt1/wpz/Llama_CDG/dataset/LF_train/3.1-8B-instruct/concrete-mislead-critic_ratio0.75.json  \
--hack_ratio 0.75
"""